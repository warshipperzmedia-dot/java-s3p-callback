...
A Spring Boot microservice for handling S3P payment transaction callbacks.

## Features

- ✓ REST API for receiving payment callbacks
- ✓ Persistent storage with JPA/Hibernate
- ✓ Multi-environment support (development with H2, production with MySQL)
...
```
Retrieve a specific callback by transaction ID.
